...
-64 -10 -81 -26 l-24 -22 -11 25 c-12 26 -20 28 -61 16z" />
    ...
    <main>
        ...
        <form id="etap2">
            ...
            <input type="text" placeholder="Miejscowosc" />
            <input type="text" placeholder="Wojewodztwo" />
            <input type="text" placeholder="Kod pocztowy" />
            <input type="text" placeholder="Ulica" />
            <input type="text" placeholder="Nr. domu/lokalu" />
            <input type="submit" value="Zarejestruj" onClick="location.href='index.php';" />
        </form>


        <input type="checkbox" name="regulamin">
        <label for="regulamin"> Akceptuje regulamin sklepu* </label>
