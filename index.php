            ...
            <div class="button4">
                ...
                <div id="konto">
                   ...
                   if(isset($_SESSION['user'])){
                    ...
                    <input style='background-color=red' type='submit' value='Wyloguj się'>
                    </form>";
                   }else{
        ...
        ?>
            ...
            <div class="button3">
                ...
                <div id="pomoc">
                    ...
                    <div class="mapouter"><div class="gmap_canvas"><iframe src="https://maps.google.com/maps?q=Cz%C4%99stochowa%20jaworowa%2046&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed" id="gmap_canvas" frameborder="0" scrolling="no" style="width: 200px; height: 280px;"></iframe><a href="https://fnftest.net" style="display:none"></a><style>.mapouter{position:relative;text-align:right;height:280px;width:200px;}</style><a href="https://googlemapsiframegenerator.com" style="display:none"></a><style>.gmap_canvas{overflow:hidden;background:none!important;height:280px;width:200px;}</style></div></div>
                </div>
            </div>
            <div class="button1">
                <svg style="width: 100%;height: 100%;" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
...
-64 -10 -81 -26 l-24 -22 -11 25 c-12 26 -20 28 -61 16z" />
    ...
    <div id="navbar">
        <nav>
            <ul>
                <li>
                    <a onclick="telewizory()">
                        <div class="obrazek"><svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24">
                                <path
                        ...
                        <div class="kategoria">Telewizory</div>
                        <div class="kategorie">
                            <ul>
                                <li>
                                    <div class="pasek">Telewizory</div>
                                </li>
                                <li>
                                    <div class="pasek">Soundbary</div>
                                </li>
                                <li>
                                    <div class="pasek">Kina Domowe</div>
                                </li>
                                <li>
                                    <div class="pasek">Głośniki</div>
                                </li>
                                <li>
                                    <div class="pasek">Słuchawki</div>
                                </li>
                                <li>
                                    <div class="pasek">DVD</div>
                                </li>
                            </ul>
                        </div>
                    </a>
                ...
                <li>
                    <a onclick="komputery()">
                        <div class="obrazek"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <g id="_01_align_center" data-name="01 align center">
                                    <path
                                        d="M22,15V3H2V15H0v3a3,3,0,0,0,3,3H21a3,3,0,0,0,3-3V15ZM4,5H20V15H14.921l-.847,1H9.925l-.846-1H4ZM22,18a1,1,0,0,1-1,1H3a1,1,0,0,1-1-1V17H8.151L9,18h6l.847-1H22Z" />
                                </g>
                            </svg></div>
                        <div class="kategoria">Komputery</div>
                        <div class="kategorie">
                            <ul>
                                <li>
                                    <div class="pasek">Procesory</div>
                                </li>
                                <li>
                                    <div class="pasek">Karty graficzne</div>
                                </li>
                                <li>
                                    <div class="pasek">Laptopy</div>
                                </li>
                                <li>
                                    <div class="pasek">SSD/HDD</div>
                                </li>
                                <li>
                                    <div class="pasek">Zasilacze</div>
                                </li>
                                <li>
                                    <div class="pasek">Obudowy</div>
                                </li>
                            </ul>
                        </div>
                    </a>
                ...
                <li>
                    <a onclick="smartfony()">
                        ...
                        <div class="kategoria">Smartfony</div>
                        <div class="kategorie">
                            <ul>
                                <li>
                                    <div class="pasek">Smartfony</div>
                                </li>
                                <li>
                                    <div class="pasek">Smartwache</div>
                                </li>
                                <li>
                                    <div class="pasek">Tablety</div>
                                </li>
                                <li>
                                    <div class="pasek">Eboki</div>
                                </li>
                ...
                <li>
                    <a onclick="konsole()">
                        <div class="obrazek"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="kategoria">Konsole</div>
                        <div class="kategorie">
                            <ul>
                                <li>
                                    <div class="pasek">Xbox</div>
                                </li>
                                <li>
                                    <div class="pasek">Nintemdo</div>
                                </li>
                                <li>
                                    <div class="pasek">Playstation</div>
                                </li>
                ...
                <li>
                    <a onclick="monitory()">
                        ...
                        <div class="kategoria">Monitory</div>
                        <div class="kategorie">
                            <ul>
                                <li>
                                    <div class="pasek">21"</div>
                                </li>
                                <li>
                                    <div class="pasek">22"</div>
                                </li>
                                <li>
                                    <div class="pasek">24"</div>
                                </li>
                                <li>
                                    <div class="pasek">27"</div>
                                </li>
                                <li>
                                    <div class="pasek">29"</div>
                                </li>
                                <li>
                                    <div class="pasek">32"+</div>
                                </li>
                            </ul>
                        </div>
                    </a>
                ...
                <li>
                    <a onclick="akcesoria()">
                        <div class="obrazek"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <g id="_01_align_center" data-name="01 align center">
                                    <path
                                        d="M19,8.184V0H5V8.184A3,3,0,0,0,3,11v4a9,9,0,0,0,18,0V11A3,3,0,0,0,19,8.184ZM7,2H17V8H7ZM19,15A7,7,0,0,1,5,15V11a1,1,0,0,1,1-1H18a1,1,0,0,1,1,1Z" />
                                    <rect x="13" y="4" width="2" height="2" />
                                    <rect x="9" y="4" width="2" height="2" />
                                </g>
                            </svg>
                        </div>
                        <div class="kategoria">Akcesoria</div>
                        <div class="kategorie">
                            <ul>
                                <li>
                                    <div class="pasek">Kable</div>
                                </li>
                                <li>
                                    <div class="pasek">Słuchawki</div>
                                </li>
                                <li>
                                    <div class="pasek">Myszki</div>
                                </li>
                                <li>
                                    <div class="pasek">Klawiatury</div>
                                </li>
                                <li>
                                    <div class="pasek">Pendrive</div>
                                </li>
                                <li>
                                    <div class="pasek">Zasilanie</div>
                                </li>
                            </ul>
                        </div>
                    </a>
                ...
                <li>
                    <a onclick="polecane()">
                        ...
                        <div class="kategoria">Polecane</div>
                        <div class="kategorie">
                            <ul>
                                <li>
                                    <div class="pasek">Konsola Xbox</div>
                                </li>
                                <li>
                                    <div class="pasek">Iphone</div>
                                </li>
                                <li>
                                    <div class="pasek">Dysk SSD</div>
                                </li>
                                <li>
                                    <div class="pasek">Kino domowe</div>
                                </li>
                                <li>
                                    <div class="pasek">Monitor MSI</div>
                                </li>
                                <li>
                                    <div class="pasek">RTX 2137 ti 997GB</div>
                                </li>
